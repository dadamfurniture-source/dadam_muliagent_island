...
import { DrawingAgent } from "@/lib/ai/agents/drawing-agent";
...
const VALID_AGENTS: AgentRole[] = ["consultation", "image", "quote", "schedule", "drawing"];
...
5. drawing - 도면 에이전트: 가구 도면 작성 안내, 치수 제안, 도면→이미지 변환
